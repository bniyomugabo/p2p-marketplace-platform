<?php
// api/invitations/resend.php
// ============================================
// RESEND INVITATION API ENDPOINT
// ============================================
...
try {
    ...
    $invitationModel->resendInvitation($invitationId);

    // Log the action
    error_log("Invitation {$invitationId} resent by admin {$_SESSION['user_id']}");
